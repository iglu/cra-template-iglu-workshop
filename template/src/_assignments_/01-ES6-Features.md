...
1. Create a new utility file (`src/utils/helloWorld.ts`)
2. In that file write a function that simply says "Hello World" in the console (console.log()) whenever invoked (Arrow function syntax)
3. export function (Modules)
4. import function in App.tsx (Modules)
5. Invoke function inside App component
